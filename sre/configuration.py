...
data_arg.add_argument('--embedding_path', type=str, default=None, help="directory to save embedding for test dataset")
data_arg.add_argument('--label_path', type=str, default='./label', help="directory to save speaker labels")
data_arg.add_argument('--dialogue_path', type=str, default='./dialogue', help="dialogue act dataset directory")
data_arg.add_argument('--trial_pair', type=str, default=None, help="list of trial pairs for verification")
...
model_arg.add_argument('--restore_model', type=str, default=None, help="name of model to restore")
